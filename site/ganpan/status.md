...
- The entrance of this sign lists all piece addresses in one code block and has one sentence, marked as the owner's request, asking the AI to show them that way. When the author checked, copying the block and sending it once opened the pieces, and the apps did not become guarded at the request. This was one check by one person.
