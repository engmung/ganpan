...
//
//   tools/tests/checker/bad/         걸려야 하는 글. 하나도 안 걸리면 실패.
//   tools/tests/checker/good/        걸리면 안 되는 글. 하나라도 걸리면 실패(오탐).
//   tools/tests/checker/known-gaps/  나쁜 글인데 지금 규칙으로는 못 잡는 것. 실패로 치지 않고 수만 센다.
...
console.log(`\n알려진 빈틈 ${gaps.length - closed.length}건 (tools/tests/checker/known-gaps/)`);
